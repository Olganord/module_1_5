...
immutable_var = 1, 2, 3, 'разные типы данных', True
print(immutable_var)
#print(type(immutable_var)) #Задание 1,2
print()

#immutable_var[0] = 100
#Консоль: TypeError: 'tuple' object does not support item assignment - Ошибка типа данных:
#кортеж не поддерживает обращение по элементам. - Задание 3."""
print()
mutable_list = [1, 2, 3, 'разные типы данных', True]
#print(type(mutable_list))
mutable_list[0] = 100
mutable_list[4] = 0
print(mutable_list)
mutable_list[3] = 'измененная строка'
mutable_list.append(123)
mutable_list.extend('123')
mutable_list.extend(['123', 2])
mutable_list.remove('123')
print(mutable_list[0:4])
print(mutable_list[0:4:2])# Варианты изменения элементов строки, Задание 4
